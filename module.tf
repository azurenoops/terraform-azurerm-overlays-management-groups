...
# their parents. The local variable "es_management_group_output"
# is used to merge the response from each block to return the
# configuration data from the module in a single object.
